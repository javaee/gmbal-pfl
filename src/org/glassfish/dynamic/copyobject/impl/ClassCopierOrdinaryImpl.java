...
import org.glassfish.dynamic.copyobject.spi.Copy ;
import org.glassfish.dynamic.copyobject.spi.CopyInterceptor ;

import static org.glassfish.dynamic.copyobject.spi.CopyType.* ;

import org.glassfish.dynamic.copyobject.spi.LibraryClassLoader ;
...
//******************************************************************************
	...
	org.glassfish.dynamic.codegen.spi.Type.class.getPackage() ;
    private static final Package CODEGEN_IMPL = 
	org.glassfish.dynamic.codegen.impl.Node.class.getPackage() ;
