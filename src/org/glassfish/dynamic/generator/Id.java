...
package org.glassfish.dynamic.generator;
...
public @interface Id {
    /** Annotation applied to parameter of an @Builder method to indicate
     * which delegate field or property of the client class is initialized
     * with the parameter.
     * @return the id.
     */
    String value() ;
